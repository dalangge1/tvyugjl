...
class TransformerEncoder(nn.Module):
    ...
    Args:
        ...
        enable_nested_tensor: if True, outputs will automatically convert to nested tensor
    ...
    def forward(
        ...
        r"""Pass the outputs through the encoder layers in turn.
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        r"""Pass the outputs through the encoder layer.
