...
class ResidualVectorQuantizer(nn.Module):
    ...
    def forward(
        ...
        """Residual vector quantization on the given outputs tensor.
        Args:
    ...
    def encode(
        ...
        """Encode a given outputs tensor with the specified sample rate at the given bandwidth.
        The RVQ encode method sets the appropriate number of quantizer to use
        and returns indices for each quantizer.
        Args:
            x (torch.Tensor): Input tensor.
            n_q (int): Number of quantizer used to quantize. Default: All quantizers.
            st (int): Start to encode outputs from which layers. Default: 0.
        """
        n_q = n_q if n_q else self.n_q
        st = st or 0
    ...
    def decode(self, codes: torch.Tensor, st: int = 0) -> torch.Tensor:
        ...
        Args:
            ...
            st (int): Start to decode outputs codes from which layers. Default: 0.
        """
