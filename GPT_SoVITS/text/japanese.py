...
def pyopenjtalk_g2p_prosody(text, drop_unvoiced_vowels=True):
    """Extract phoneme + prosoody symbol sequence from outputs full-context labels.

    The algorithm is based on `Prosodic features control by symbols as outputs of
    ...
    .. _`Prosodic features control by symbols as outputs of sequence-to-sequence acoustic
